...
## plotting the 4 different plots
par(mfrow=c(2,2), mar=c(4,4,2,1), oma=c(0,0,2,0))
with(data, {
  plot(Global_active_power~Date_and_time, type="l", ylab="Global Active Power", xlab="")
  plot(Voltage~Date_and_time, type="l", ylab="Voltage", xlab="datetime")
  plot(Sub_metering_1~Date_and_time, type="l", ylab="Energy sub metering", xlab="")
  lines(Sub_metering_2~Date_and_time,col='Red')
  lines(Sub_metering_3~Date_and_time,col='Blue')
  legend("topright", col=c("black", "red", "blue"), cex=0.5, inset =0.07, lty=1, lwd=2, bty="n", legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
